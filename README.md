...
핵심은 **대화·통화 중 막히는 순간에 다음 한마디를 돕는 AI**입니다. 홈의 주 행동은 ‘지금 대화 도움받기’, 보조 행동은 ‘미리 연습하기’입니다. 같은 상대·상황·목표·지킬 선을 실전 도움과 평소 연습에 재사용합니다. 현재 실전 입력은 최대 8초씩 녹음하거나 문자를 입력한 뒤 답변을 제안하는 방식입니다. 같은 휴대폰의 통화 음성을 직접 가져오거나 연속 스트리밍하지 않습니다. 실전 입력·결과의 자동 장기 기록도 현재 제공하지 않습니다.

평소에는 AI 상대와 연습 → 실제 발화에 근거한 복기 → 같은 장면 재연습으로 이어집니다. 녹음 복기와 기초 훈련은 이 흐름의 보조 기능입니다. 메시지 답장·용어·상대 설정·사용 안내는 더보기에 둡니다. AI 요청·일상 대화·커뮤니티·대화 관찰은 해커톤의 주 동선에서 제외하고 기존 기록/주소는 보존합니다.
...
- `/`: 지금 대화 도움받기, 미리 연습하기, 최근 개인 기록 한 건
