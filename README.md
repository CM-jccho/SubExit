...
홈의 대화 연습·메시지 답장·대화 기초 훈련·AI 요청 연습 중 목적부터 선택합니다. 관심 상황은 대화 연습에 들어간 뒤 선택하며, 하단은 홈·내 기록·더보기로 구분합니다. 더보기에는 용어 노트·AI 대화 상대·일상 대화·사용 안내만 모았습니다. 상대·목표·지킬 선을 담은 카드로 AI 역할 상대와 연습하며, 후보 선택 또는 음성·문자 입력을 이용합니다. 메시지 답장, 외부 녹음 분석, 용어 노트, 기초 훈련, 일상 대화, AI 요청 연습을 지원합니다.
...
- [네 가지 목적 중심 구성 및 검증](docs/validation/four-purpose-home-2026-09-17.md)
