...
새 브랜드 주소: https://speakcoaching.onrender.com/ — 화면 배포 완료, Gemini 키 등록 전입니다. 기존 브라우저 기록은 이전 주소에서 확인합니다. [주소 전환·배포 기록](docs/deployment/speakcoaching-brand-2026-09-17.md)

핵심은 **대화·통화 중 막히는 순간에 다음 한마디를 돕는 AI**입니다. 핵심 기능은 대화 연습, 녹음 첨부·분석·코칭, 실시간 음성 기반 프롬프트(다음 말 힌트)의 세 가지입니다. 홈은 ‘지금 대화 도움받기’를 가장 강조하고 ‘미리 연습하기’와 ‘녹음 분석·코칭’도 바로 제공합니다. 같은 상대·상황·목표·지킬 선을 실전 도움과 평소 연습에 재사용합니다. 현재 실전 입력은 최대 8초씩 녹음하거나 문자를 입력한 뒤 답변을 제안하는 방식입니다. 같은 휴대폰의 통화 음성을 직접 가져오거나 연속 스트리밍하지 않습니다. 실전 입력·결과의 자동 장기 기록도 현재 제공하지 않습니다.
