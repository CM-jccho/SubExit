...
'''
page = '<!doctype html><html lang="ko"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>든든콜 — IA 및 기능명세서</title><style>' + style + '</style></head><body><header><strong>든든콜 · 제품 구조와 기능명세</strong><p>지금 대화 중에는 도움을 · 평소에는 같은 상황을 연습</p></header><main><div class="notice"><strong>검토 기준 2026-09-17.</strong> 소스 수정·자동 검증과 운영 배포를 구분합니다. 실제 모바일·마이크·AI 실전 응답과 지연는 확인이 남아 있습니다.</div><nav aria-label="문서 목차">' + ''.join(toc) + '</nav>' + ''.join(out) + '<footer>원본: ia-functional-spec-2026-09-17.md · 외부 폰트·스크립트 없이 열고 인쇄할 수 있습니다.</footer></main></body></html>'
