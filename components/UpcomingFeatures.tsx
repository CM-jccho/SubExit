const upcoming = [
  ...
  },
  {
    id: "recording",
    area: "audio",
    title: "여러 사람의 대화·자동 화자 구분",
    description:
      "여러 사람의 목소리를 자동으로 구분하는 기능을 검토하고 있어요. 현재는 최대 30분·50MB 파일을 가져오고, 변환한 문자에서 화자를 직접 확인해요.",
  },
  {
    id: "live",
    area: "audio",
    title: "연속 음성 코칭 지원 확대",
    description:
      "더 많은 브라우저에서 연속 음성 코칭을 쓰는 방법을 검토하고 있어요. 현재 지원 브라우저에서는 계속 듣고, 그 외에는 최대 4초씩 녹음한 뒤 힌트를 받아요.",
  },
  {
    id: "sync",
    area: "storage",
